...
// Copy pasted from https://github.com/Chocohead/Fabric-ASM/blob/master/src/com/chocohead/mm/api/EnumAdder.java
// Under MPL license at http://mozilla.org/MPL/2.0/.
...
public final class EnumAdder {
    ...
    public EnumAdder(String enumType, Object... parameterTypes) {
     ...
     */
    public void build() {
        ClassTinkerers.addTransformation(type, EnumExtender.makeEnumExtender(this));
        finished = true;
    }
